...
import { MapPin, ExternalLink, GraduationCap, ChevronRight } from 'lucide-react';
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow h-full flex flex-col">
      ...
      <div className="w-full h-40 flex items-center justify-center bg-blue-100">
        {hasImage ? (
          ...
          <span className="text-blue-900 text-center text-lg font-semibold">{institute.name}</span>
        )}
      </div>

      <div className="flex flex-col justify-between flex-grow p-5">
        {/* Institute Name */}
        <h3 className="font-semibold text-lg text-gray-800 mb-3">{institute.name}</h3>
